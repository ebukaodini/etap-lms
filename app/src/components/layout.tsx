...
const Layout: React.FC<LayoutProps> = ({ children, guards }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="flex flex-col items-start justify-start w-2/4 min-h-screen container gap-y-10 py-10">
        {/* user profile */}
        {user && (
          <div className="absolute top-5 end-5 bg-gray-200 p-2 rounded flex flex-col gap-y-2">
            ...
            <button
              className="font-semibold text-xs rounded p-1 bg-gray-300"
              type="button"
