...
const Auth: React.FC<AuthProps> = () => {
  ...
  const { isSubmitting, submitting, credentials, setCredential, errors } =
    useForm();
  ...
  const handleSignIn = (e: FormEvent) => {
    ...
    signIn(credentials)
      .then(() => {
        submitting(false);
        if (useStore.getState().user!.role === "LEARNER")
          navigate("/subjects", { replace: true });
        else navigate("/admin/subjects", { replace: true });
      })
      .catch((error) => {
        submitting(false);
